...
public class register1_7_2 implements Register {
	public boolean registerEntities(){
		...
		try {
			...
			c_map.put("MEWool", MEFallingBlock1_7_2.class);

			Field d = entityTypeClass.getDeclaredField("d");
			d.setAccessible(true);
			HashMap d_map = (HashMap) d.get(null);
			d_map.put(MESheep1_7_2.class, "MESheep");
			d_map.put(MEFallingBlock1_7_2.class, "MEWool");
	...
	public FallingBlock spawnSheep(Plugin m, String arena, Location t, final Integer color) {
		...
		final MESheep1_7_2 t_ = new MESheep1_7_2(arena, t, (net.minecraft.server.v1_7_R1.World) ((CraftWorld) t.getWorld()).getHandle());
	...
	public FallingBlock spawnWool(Plugin m, String arena, Location t, final Integer color) {
		final Object w = ((CraftWorld) t.getWorld()).getHandle();
		final MEFallingBlock1_7_2 t_ = new MEFallingBlock1_7_2(arena, t, (net.minecraft.server.v1_7_R1.World) ((CraftWorld) t.getWorld()).getHandle());
	...
	public boolean isSheep(LivingEntity entity) {
		return ((CraftLivingEntity) entity).getHandle() instanceof MESheep1_7_2;
	}
}

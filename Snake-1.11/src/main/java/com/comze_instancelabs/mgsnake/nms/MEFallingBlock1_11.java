...
public class MEFallingBlock1_11 extends EntityFallingBlock implements FallingBlock {

	private String arena;

	public MEFallingBlock1_11(String arena, Location loc, World world, Integer color) {

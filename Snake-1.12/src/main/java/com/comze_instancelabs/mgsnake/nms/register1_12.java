...
public class register1_12 implements Register {
	public boolean registerEntities(){
		...
		EntityTypes.b.a(91, localMinecraftKey, MESheep1_12.class);
	...
	public FallingBlock spawnSheep(Plugin m, String arena, Location t, final Integer color) {
		...
		final MESheep1_12 t_ = new MESheep1_12(arena, t, (net.minecraft.server.v1_12_R1.World) ((CraftWorld) t.getWorld()).getHandle());

		Bukkit.getScheduler().runTask(m, new Runnable(){
			public void run(){
				//t_.id = Block.e(35);
				//t_.data = color;
				((net.minecraft.server.v1_12_R1.World) w).addEntity(t_, CreatureSpawnEvent.SpawnReason.CUSTOM);
	...
	public FallingBlock spawnWool(Plugin m, String arena, Location t, final Integer color) {
		final Object w = ((CraftWorld) t.getWorld()).getHandle();
		final MEFallingBlock1_12 t_ = new MEFallingBlock1_12(arena, t, (net.minecraft.server.v1_12_R1.World) ((CraftWorld) t.getWorld()).getHandle(), color);
	...
	public boolean isSheep(LivingEntity entity) {
		return ((CraftLivingEntity) entity).getHandle() instanceof MESheep1_12;
	}
